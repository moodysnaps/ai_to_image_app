...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/aiimageappworker)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aiimageappworker
```

A live public deployment of this template is available at [https://aiimageappworker.templates.workers.dev](https://aiimageappworker.templates.workers.dev)
